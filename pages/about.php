...
<div class="container">
    <div style="max-width: 900px; margin: 0 auto;">
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: center; margin-bottom: 50px;">
            <div>
                <h2 style="font-size: 36px; color: #ff6b6b; margin-bottom: 20px;">Our Mission</h2>
                <p style="font-size: 18px; line-height: 1.8; color: #666; margin-bottom: 30px;">
                    Warm Hands is a community-driven organization dedicated to helping those in need through organized 
        ...
        <h2 style="font-size: 36px; color: #ff6b6b; margin-bottom: 20px;">What We Do</h2>
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 30px; margin-bottom: 40px;">
            <div style="background: white; padding: 30px; border-radius: 10px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
                <i class="fas fa-hands-helping" style="font-size: 48px; color: #ff6b6b; margin-bottom: 15px;"></i>
            ...
            <div style="background: white; padding: 30px; border-radius: 10px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
                <i class="fas fa-tshirt" style="font-size: 48px; color: #ff6b6b; margin-bottom: 15px;"></i>
            ...
            <div style="background: white; padding: 30px; border-radius: 10px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
                <i class="fas fa-medkit" style="font-size: 48px; color: #ff6b6b; margin-bottom: 15px;"></i>
        ...
        <h2 style="font-size: 36px; color: #ff6b6b; margin-bottom: 20px;">Our Impact</h2>
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: center; margin-bottom: 50px;">
            <div>
