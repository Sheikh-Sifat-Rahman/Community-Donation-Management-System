...
<div class="hero" style="background: linear-gradient(rgba(255, 107, 107, 0.85), rgba(255, 142, 83, 0.85)), url('<?php echo SITE_URL; ?>/assets/images/community-support.jpg'); background-size: cover; background-position: center;">
    <h1>Aid Seekers</h1>
...
<div class="container">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(350px, 1fr)); gap: 25px;">
        ...
        <div style="background: white; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.1); overflow: hidden; transition: transform 0.3s;">
            <div style="background: linear-gradient(135deg, #ff6b6b, #ff8e53); color: white; padding: 20px;">
            ...
            <div style="padding: 20px;">
                <div style="display: grid; gap: 12px;">
                    ...
                    <?php if ($seeker['Email']): ?>
                    <div style="display: flex; align-items: center; gap: 10px; padding: 10px; background: #f8f9fa; border-radius: 6px;">
                        <i class="fas fa-envelope" style="color: #ff6b6b; width: 20px;"></i>
                        <span style="color: #666; font-size: 14px;"><?php echo htmlspecialchars($seeker['Email']); ?></span>
                    </div>
                    <?php endif; ?>
                    
                    <div style="display: flex; align-items: center; gap: 10px; padding: 10px; background: #f8f9fa; border-radius: 6px;">
                        <i class="fas fa-money-bill-wave" style="color: #ff6b6b; width: 20px;"></i>
                        <span style="color: #666; font-size: 14px;">Income: ৳<?php echo number_format($seeker['Monthly_Income']); ?>/month</span>
                    </div>
                    
                    <div style="display: flex; align-items: center; gap: 10px; padding: 10px; background: #f8f9fa; border-radius: 6px;">
                        <i class="fas fa-users" style="color: #ff6b6b; width: 20px;"></i>
                        <span style="color: #666; font-size: 14px;">Family: <?php echo $seeker['Family_Members']; ?> members</span>
                    </div>
                    
                    <?php if ($seeker['Reason']): ?>
                    <div style="padding: 10px; background: #fff3cd; border-radius: 6px; border-left: 4px solid #ff6b6b;">
                        <div style="color: #ff6b6b; font-weight: 600; font-size: 13px; margin-bottom: 5px;">
                            <i class="fas fa-comment-dots"></i> Reason for Request:
                        </div>
